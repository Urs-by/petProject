...
class UserForm(forms.Form):
    ...
    image = forms.ImageField(widget=forms.ClearableFileInput(), required=False, label="Ваше фото")
    ...
    def clean(self):
        ...
        if password and confirm_password:
            if password != confirm_password:
                raise forms.ValidationError("Пароли не совпадают. Пожалуйста, введите их заново.")
